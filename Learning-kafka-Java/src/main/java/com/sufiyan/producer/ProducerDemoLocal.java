...
public class ProducerDemoLocal {
	/*
	...
	private static final Logger log = LoggerFactory.getLogger(ProducerDemoLocal.class.getSimpleName());
	...
	public static void main(String[] args) {
		...
		// username=\"797f6NHDaSKhaxV0VLgFvN\"
		// password=\"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..kNLhjyH_tTL9sYINbIh9sBkjz2oMWl-eNfjBESQRr74\";");
		...
		ProducerRecord<String, String> producerRecord = new ProducerRecord<String, String>("quickstart-demo",
				"Hello world 😊!!!");
